...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_draw.setGeometry(QtCore.QRect(320, 20, 41, 23))
        ...
        self.output_close_price = QtWidgets.QLabel(self.centralwidget)
        self.output_close_price.setGeometry(QtCore.QRect(510, 220, 54, 20))
        self.output_close_price.setObjectName("output_close_price")
        self.lbl_close_price = QtWidgets.QLabel(self.centralwidget)
        self.lbl_close_price.setGeometry(QtCore.QRect(423, 220, 71, 20))
        self.lbl_close_price.setObjectName("lbl_close_price")
        self.input_from_date = QtWidgets.QLineEdit(self.centralwidget)
        self.input_from_date.setGeometry(QtCore.QRect(410, 250, 91, 20))
        self.input_from_date.setObjectName("input_from_date")
        self.input_to_date = QtWidgets.QLineEdit(self.centralwidget)
        self.input_to_date.setGeometry(QtCore.QRect(510, 250, 91, 20))
