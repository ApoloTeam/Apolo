...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.by_stock_code.setGeometry(QtCore.QRect(10, 10, 681, 81))
        ...
        self.btn_update_hist_data = QtWidgets.QPushButton(self.by_stock_code)
        self.btn_update_hist_data.setGeometry(QtCore.QRect(320, 20, 131, 23))
        self.btn_update_hist_data.setObjectName("btn_update_hist_data")
        self.by_stock_list = QtWidgets.QGroupBox(self.centralwidget)
        self.by_stock_list.setGeometry(QtCore.QRect(10, 100, 681, 81))
        ...
        self.btn_update_sz50.raise_()
        self.btn_update_hs300.raise_()
        self.btn_update_zz500.raise_()
        self.by_stock_code.raise_()
        self.textEdit = QtWidgets.QTextEdit(self.centralwidget)
        self.textEdit.setGeometry(QtCore.QRect(10, 320, 681, 331))
        ...
        self.for_all_stock.setGeometry(QtCore.QRect(10, 240, 681, 71))
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 190, 681, 51))
        self.groupBox.setObjectName("groupBox")
        self.btn_update_statement = QtWidgets.QPushButton(self.groupBox)
        self.btn_update_statement.setGeometry(QtCore.QRect(10, 20, 131, 23))
        self.btn_update_statement.setObjectName("btn_update_statement")
        self.rdb_bs = QtWidgets.QRadioButton(self.groupBox)
        self.rdb_bs.setGeometry(QtCore.QRect(160, 20, 101, 16))
        self.rdb_bs.setObjectName("rdb_bs")
        self.rdb_pl = QtWidgets.QRadioButton(self.groupBox)
        self.rdb_pl.setGeometry(QtCore.QRect(270, 20, 89, 16))
        self.rdb_pl.setCheckable(True)
        self.rdb_pl.setChecked(False)
        self.rdb_pl.setObjectName("rdb_pl")
        self.rdb_cash = QtWidgets.QRadioButton(self.groupBox)
        self.rdb_cash.setGeometry(QtCore.QRect(320, 20, 89, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_update_hist_data.setText(_translate("MainWindow", "Update History data"))
