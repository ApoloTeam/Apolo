...
class Table_creator:
    ...
    #合并资产负债表－季度
    def get_consolidated_bs_season(self,table_name):
        metadata = MetaData()
        table_consolidated_bs_season= Table(table_name,metadata,
                                            Column('报告日期',Date(),primary_key=True),     #时间和日期
                                            Column('货币资金(万元)',DECIMAL(20,4)),  
                                            Column('结算备付金(万元)',DECIMAL(20,4)),  
                                            Column('拆出资金(万元)',DECIMAL(20,4)),  
    ...
    #合并利润表－季度
    def get_consolidated_pl_season(self,table_name):
        metadata = MetaData()
        table_consolidated_pl_season= Table(table_name,metadata,
                                            Column('报告日期',Date(),primary_key=True),     #时间和日期
                                            Column('营业总收入(万元)',DECIMAL(20,4)),                                                 
                                            Column('营业收入(万元)',DECIMAL(20,4)),                                                 
                                            Column('利息收入(万元)',DECIMAL(20,4)),                                                 
        ...
        return table_consolidated_pl_season                
